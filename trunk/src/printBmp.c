...
int generateBitmapImage(unsigned char** image, int height, int width, char* imageFileName)
{
...
int generateGameTableBitmap(table* gameTable, char* outFileName)
{
	int i, j, k, h;
	...
	h = generateBitmapImage(image, gameTable->rows, gameTable->columns, outFileName);
